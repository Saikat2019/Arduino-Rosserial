...
if("FALSE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/saikat/arduino_rs/src/rosserial-jade-devel/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/saikat/arduino_rs/devel)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/saikat/arduino_rs/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saikat/arduino_rs/install/${idir}'.  ${_report}")
    endif()
